      ...
      <div className="container text--left">
        <div className="row">
          ...
          <div className="col" style={{marginBlock: "auto"}}>
            ...
            <p>1. 作为你学习Linux系统的一个样板</p>
			<p>2. 支持Docker程序，你可以使用Docker扩展你的需求</p>
			<p>3. 作为家用的文件存储器，文件共享器</p>
			<p>4. 内网穿透跳板机，或P2P把家里的设备跟异地的设备网络组成同一个内网</p>
			<p>5. 博客系统记录你学习和生活的点点滴滴，既能分享，又能保留历史记忆</p>
          </div>
        </div>
      </div>
    </div>
